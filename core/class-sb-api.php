...
if ( ! class_exists( 'StarterBlocks_API' ) ) {


	class StarterBlocks_API {

		protected $api_base_url = 'https://us-east4-starterblocks.cloudfunctions.net/';
//		protected $api_base_url = 'http://0.0.0.0:8080/';
		protected $default_request_headers = array();
		protected $api_request_body = array();

		/**
		 * StarterBlocks_APIs constructor
		 */
		public function __construct() {

			add_action( 'starterblocks_api_request_headers', array( $this, 'request_verify' ) );

			$this->default_request_headers = apply_filters( 'starterblocks_api_request_headers', array() );
