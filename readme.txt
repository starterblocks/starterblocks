...
The StarterBlocks plugin uses a custom API to fetch our content library and  templates. To improve the service and stability we store logs which may or may not contain the following "Non-Personal Information:"
- browser type
- referring site
